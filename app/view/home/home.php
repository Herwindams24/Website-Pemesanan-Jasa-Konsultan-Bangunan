            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 about-img">
                        <img src="https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1050&q=80" alt="" height="300px">
                    </div>

                    <div class="col-lg-6 content">
                        <h2>Mututama Teknik</h2>
                        <h3>CV. Mututama Teknik menawarkan pelayanan jasa konsultasi serta konsep pembangunan fasilitas publik maupun rumah pribadi.</p>
                            <ul>
                                <li><i class="ion-android-checkmark-circle"></i> Konsultasi Kontruksi</li>
                                <li><i class="ion-android-checkmark-circle"></i> Konsultasi Denah</li>
                                <li><i class="ion-android-checkmark-circle"></i> Konsep Desain</li>
                            </ul>
    ...
    ============================-->
        <section id="testimonials" class="wow fadeInUp">
            <div class="container">
                <div class="section-header">
                    <h2>Testimonials</h2>
                    <p>We have many satisfied clients say sbout us</p>
                </div>
                <div class="owl-carousel testimonials-carousel">

                    <div class="testimonial-item">
                        <p>
                            "Profesional dalam merencanakan dan pengawasan konstruksi."
                        </p>
                        <img src="/webpro/public/asset/img/team-1.jpg" class="testimonial-img" alt="">
                        <h3>Saul Goodman</h3>
                        <h4>Ceo &amp; Founder</h4>
                    </div>
                    ...
                    <div class="testimonial-item">
                        <p>
                            "Consultant for Engineering has remarkable job in helping construction company in doing the project"
                        </p>
                        <img src="/webpro/public/asset/img/team-2.jpg" class="testimonial-img" alt="">
                        <h3>Sara Wilsson</h3>
                        <h4>Designer</h4>
                    </div>
                    ...
                    <div class="testimonial-item">
                        <p>
                            "Memiliki Tim Profesional yang mengedepankan pelayanan terbaik"
                        </p>
                        <img src="https://images.unsplash.com/photo-1586297135537-94bc9ba060aa?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=80" class="testimonial-img" alt="">
                        <h3>Jena Karlis</h3>
                        <h4>Store Owner</h4>
                    </div>
                    ...
                    <div class="testimonial-item">
                        <p>
                            "Dapat memberikan solusi terbaik bagi anda yang memiliki berbagai permasalahan dalam engineering civil"
                        </p>
                        <img src="https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=80" class="testimonial-img" alt="">
                        <h3>Matt Brandon</h3>
                        <h4>Freelancer</h4>
                    </div>
                </div>
    ...
    ============================-->
        <section id="contact" class="wow fadeInUp">
                ...
                <div class="row contact-info">
                    ...
                    <div class="col-md-4">
                        <div class="contact-address">
                            ...
                            <h3>Address</h3>
                            <address>Jln. Ikan Bandeng Raya Kav.71/No.04, Lamongan, Indonesia</address>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="contact-phone">
                            ...
                            <h3>Phone Number</h3>
                            <p><a href="tel:+6285233150035">+62 85 233 150 035</a></p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="contact-email">
                            ...
                            <h3>Email</h3>
                            <p><a href="mailto:herwinda.ms@gmail.com">herwinda.ms@gmail.com</a></p>
                        </div>
                    </div>
            ...
            <div class="container mb-4">
                <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d8147.426536490503!2d112.78589439565819!3d-7.2701433330322285!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sid!2sid!4v1603725417759!5m2!1sid!2sid" width="1100" height="550" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
            </div>
