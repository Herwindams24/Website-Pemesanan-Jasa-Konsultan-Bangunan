...
<head>
    ...
    <title>Mututama | Forgot Password</title>
                            ...
                            <div class="col-lg">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <h3 class="h4 text-gray-900 mb-2">Forgot Your Password?</h3>
                                    ...
                                    <form class="user">
                                        ...
                                        <a href="<?= BASEURL; ?>/Account/login" class="btn btn-info btn-user btn-block">
                                            Reset Password
                                        </a>
                                    </form>
                                    <hr>
