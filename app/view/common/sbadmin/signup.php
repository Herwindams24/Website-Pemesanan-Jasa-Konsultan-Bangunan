          ...
          <div class="col-lg">
            <div class="p-5">
              ...
              <form class="user">
                ...
                <div class="form-group">
                  <input type="text" class="form-control form-control-user" id="telp" name="telp" placeholder="08xxxxxxxxxx">
                </div>
                <div class="form-group">
              ...
              <hr>
              <div class="text-center">
                <a class="small" href="<?= BASEURL; ?>/asset2/forgot-password.html">Forgot Password?</a>
              </div>
              <div class="text-center">
                <a class="small" href="<?= BASEURL; ?>/asset2/login.html">Already have an account? Login!</a>
              </div>
            </div>
          </div>
        </div>
